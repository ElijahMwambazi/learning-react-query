...
import { renderWithQueryClient } from "../../../utils/text.utils";
...
test("Reserve appointment", async () => {
  ...
  const appointments = await screen.findAllByRole(
    "button",
    {
